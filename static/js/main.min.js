...
function t(e, n, i) {
    ...
    1 : [function(t, e, n) {
        ...
        function r(t) {
            var e, n;
            "undefined" != typeof document.hidden ? (e = "hidden", n = "visibilitychange") : "undefined" != typeof document.mozHidden ? (e = "mozHidden", n = "mozvisibilitychange") : "undefined" != typeof document.msHidden ? (e = "msHidden", n = "msvisibilitychange") : "undefined" != typeof document.webkitHidden && (e = "webkitHidden", n = "webkitvisibilitychange"),
            "undefined" != typeof document.addEventListener && document.addEventListener(n,
            function() {
        ...
        u = function(parameters) {
            ...
            this.renderer = new THREE.WebGLRenderer({
                alpha: !0,
                antialias: !0,
                canvas: parameters.canvas || document.querySelector("canvas"),
                preserveDrawingBuffer: void 0 !== parameters.preserveDrawingBuffer ? parameters.preserveDrawingBuffer: void 0
            })
            THREE.Extensions = this.renderer.extensions
            this.config = {
                fps: void 0 !== parameters.fps ? parameters.fps: !1,
                profiling: void 0 !== parameters.profiling ? parameters.profiling: !1,
                logCalls: void 0 !== parameters.logCalls ? parameters.logCalls: !1
            }
            if (parameters && parameters.maxPixelRatio) var e = window.devicePixelRatio > parameters.maxPixelRatio ? parameters.maxPixelRatio: window.devicePixelRatio;
            else var e = window.devicePixelRatio;
            window.isMobile && (e = e > 1.5 ? 1.5 : e),
            this.renderer.setPixelRatio(e),
            this.setSize(parameters.width || window.innerWidth, parameters.height || window.innerHeight),
            void 0 !== parameters.autoClear && (this.renderer.autoClear = parameters.autoClear),
            void 0 !== parameters.clearColor && this.renderer.setClearColor(parameters.clearColor),
            void 0 !== parameters.supportsTextureLod && parameters.supportsTextureLod !== !0 || THREE.Extensions.get("EXT_shader_texture_lod"),
            ...
            this.config.fps && (this.fpsCounter = new c, this.counter = document.createElement("div"), document.querySelectorAll("body")[0].appendChild(this.counter), this.counter.setAttribute("style", "position:absolute;top:20px;left:100px;color:#ff00ff;display:block !important;z-index:999999;")),
            r(this)
        };
        u.prototype = {
            render: function(t) {
            ...
            update: function(t) {
                this.camera && (this.camera.updateMatrixWorld(!0), this.camera.matrixWorldInverse.getInverse(this.camera.matrixWorld)),
                _.each(this.scenes,
                function(e) {
                    this.updateCustomMaterials(e),
                    e.update && (e.updateMatrixWorld(!0), e.update(this.renderer, t))
                },
                this)
            },
            ...
            doUpdate: function() {
                ...
                return function() {
                    if (t.delta = this.clock.getDelta(), t.elapsed = this.clock.getElapsedTime(), !this.paused) {
                        ...
                        this.config.fps && this.fpsCounter.update(t,
                        function(t) {
    ...
    2 : [function(t, e, n) {
        ...
        i.prototype = {
            update: function(t, e) {
                var t = 1e3 * t.elapsed;
                this.frames++,
                t > this.lastTime + 1e3 && (this.fps = Math.round(1e3 * this.frames / (t - this.lastTime)), e(this.fps), this.lastTime = t, this.frames = 0)
            }
        },
        e.exports = i
    },
    ...
    3 : [function(t, e, n) {
        var i = {
            ...
            off: function(t, e, n) {
                ...
                this;
                for (a = t ? [t] : _.keys(this._events), c = 0, u = a.length; u > c; c++) if (t = a[c], o = this._events[t]) {
                    if (this._events[t] = i = [], e || n) for (l = 0, h = o.length; h > l; l++) r = o[l],
    ...
    4 : [function(t, e, n) {
        ...
        i.inherit(Object, {
            ...
            update: function(t) {
                return ! this.started || this.paused || this.ended ? this:
                (
                    this.elapsedTime += 1e3 * t.delta,
                    this.elapsedTime > this.duration && (this.endCallback(), this.ended = !0),
                    this
                )
            }
        }),
            ...
            function t(t) {
                ...
                this.update = function() {
                    ...
                    return function() {
                        ...
                        e += a,
                        n += o,
                        this.object.theta = e = Math.max(this.minAzimuthAngle, Math.min(this.maxAzimuthAngle, e)),
                        n = Math.max(this.minPolarAngle, Math.min(this.maxPolarAngle, n)),
                        this.object.phi = n = Math.max(r, Math.min(Math.PI - r, n));
                        var d = i.length() * s;
                        return d = Math.max(this.minDistance, Math.min(this.maxDistance, d)),
                        this.target.add(c),
                        ...
                        this.enableDamping === !0 ? (a *= 1 - this.dampingFactor, o *= 1 - this.dampingFactor) : (a = 0, o = 0),
                        s = 1,
                        c.set(0, 0, 0),
                        u || f.distanceToSquared(this.object.position) > r || 8 * (1 - p.dot(this.object.quaternion)) > r ? (f.copy(this.object.position), p.copy(this.object.quaternion), u = !1, !0) : !1
                    }
                } ()
            }
            function n(t) {
            ...
            var i, r, o = function(e, o) {
                ...
                function u(t) {
                    if (_.enabled !== !1) {
                        ...
                        C !== O.NONE && (document.addEventListener("mousemove", l, !1), document.addEventListener("mouseup", h, !1), _.dispatchEvent(k)),
                        _.onMouseDown()
                    }
                }
                function l(t) {
                ...
                function f(t) {
                    if (_.enabled !== !1 && _.enableZoom !== !1 && C === O.NONE) {
                        ...
                        e > 0 ? y.dollyOut(c()) : 0 > e && y.dollyIn(c()),
                        _.update(),
                        _.dispatchEvent(k),
                        _.dispatchEvent(j)
                    }
                ...
                this.dispose = function() {
                    ...
                    this.domElement.removeEventListener("MozMousePixelScroll", f, !1),
    ...
    7 : [function(t, e, n) {
        var i = function(t, e) {
            ...
            navigator.getVRDisplays && navigator.getVRDisplays().then(n)["catch"](function() {
            ...
            this.setPosition = function(t) {
                ...
                s.pose.position && (f.set(s.pose.position[0], s.pose.position[1], s.pose.position[2]), c.sub(f))
            },
            ...
            this.update = function() {
                if (i) {
                    var e;
                    i.getFrameData ? (i.getFrameData(s), e = s.pose) : i.getPose && (e = i.getPose()),
                    null !== e.orientation && (h.fromArray(e.orientation), t.quaternion.multiplyQuaternions(u, h).normalize()),
                    null !== e.position ? (l.fromArray(e.position), l.applyQuaternion(u), t.position.addVectors(c, l)) : t.position.set(0, 0, 0),
                    this.standing && (i.stageParameters ? (t.updateMatrix(), a.fromArray(i.stageParameters.sittingToStandingTransform), t.applyMatrix(a)) : t.position.setY(t.position.y + this.userHeight)),
    ...
    12 : [function(t, e, n) {
        ...
        r.prototype.load = function(t, e, n, r) {
            THREE.XHRLoader.prototype.load.call(this, t,
            function(t) {
                var n = JSON.parse(t),
                r = i(n);
                e(r)
    ...
    14 : [function(t, e, n) {
        ...
        r = function(t, e, n) {
            ...
            e instanceof THREE.PerspectiveCamera ? this.camera = e: (this.camera = new THREE.PerspectiveCamera, console.log(this.name + ": camera is not a Perspective Camera!")),
            ...
            THREE.Math.isPowerOfTwo(i) && THREE.Math.isPowerOfTwo(r) || (this.renderTarget.texture.generateMipmaps = !1, this.renderTarget2.texture.generateMipmaps = !1),
        ...
        r.prototype.renderWithMirror = function(t) {
            ...
            t.renderTemp(),
            t.material.uniforms.mirrorSampler.value = t.renderTarget2.texture,
            this.render(),
            this.matrixNeedsUpdate = !0,
            t.material.uniforms.mirrorSampler.value = t.renderTarget.texture,
            t.camera = e,
        ...
        r.prototype.render = function() {
            ...
            if (void 0 !== t && t instanceof THREE.Scene) {
                ...
                this.renderer.render(t, this.mirrorCamera, this.renderTarget, !0),
    ...
    15 : [function(t, e, n) {
        ...
        o.prototype.load = function() {
            var t = {};
            return this.cubemaps && (t.cubemap = r.loadSpecularCubemaps(this.cubemaps)),
        ...
        function i(t, e) {
            return {
                ...
                load: function(e, n, i, r, o) {
                    var a = this._cache;
                    _.has(a, o) ? resolve(a[o]) : t.load(e,
                    function(t) {
                        a[o] = t
                ...
                get: function(t) {
                    return _.has(this._cache, t) || console.error("Resource not found: " + t),
                    this._cache[t]
                }
            }
        }
    ...
    17 : [function(t, e, n) {
        ...
        Object.assign(i.prototype, {
            ...
            parse: function(t, e) {
                ...
                var i = this.parseImages(t.images,
                function() {
                    void 0 !== e && e(a, t)
                }),
                ...
                void 0 !== t.images && 0 !== t.images.length || void 0 !== e && e(a, t),
                a
            },
            ...
            parseGeometries: function(t) {
                var e = {};
                if (void 0 !== t) for (var n = new THREE.JSONLoader,
                    ...
                    for (var n = (new THREE.BufferGeometryLoader, 0), i = t.length; i > n; n++) {
                        ...
                        for (var a in o.offsets) if (o.offsets.hasOwnProperty(a)) {
                            ...
                            if ("index" === a) {
                                ...
                                "uv" === a || "uv2" === a ? f = 2 : "position" === a || "normal" === a || "color" === a ? f = 3 : "tangent" === a && (f = 4),
            ...
            parseTextures: function(t, e) {
                ...
                var i = {};
                if (void 0 !== t) for (var r = 0,
                o = t.length; o > r; r++) {
                    var a, s = t[r];
                    if (s.images) {
                        for (var c = [], u = 0, l = s.images.length; l > u; u++) void 0 === e[s.images[u]] && console.warn("THREE.ObjectLoader: Undefined image", s.images[u]),
                        c.push(e[s.images[u]]);
                        a = new THREE.CubeTexture(c)
                    } else void 0 === s.image && console.warn('THREE.ObjectLoader: No "image" specified for', s.uuid),
                    ...
                    void 0 !== s.wrap && (a.wrapS = n(s.wrap[0]), a.wrapT = n(s.wrap[1])),
            ...
            parseObject: function() {
                ...
                return function(e, n, i) {
                    ...
                    case "PerspectiveCamera":
                        ...
                        void 0 !== e.view && (a.view = Object.assign({},
                        e.view));
                        break;
        ...
        o.loadScene = function(t, e, n, o) {
            return new i(function(i, a) {
                ...
                r.loadScene(e + t + (o || ".json")).spread(function(t, e) {
                    ...
                    r ? (r.aspect = window.innerWidth / window.innerHeight, r.updateProjectionMatrix()) : (r = new THREE.PerspectiveCamera(50, window.innerWidth / window.innerHeight, .01, 2e3), r.position.set( - 3.5, 2, 3)),
                    t.traverse(function(e) {
                        ...
                        e instanceof THREE.DirectionalLight && (e.position.set(0, 0, 1), e.quaternion.normalize(), e.position.applyQuaternion(e.quaternion), e.quaternion.set(0, 0, 0, 0), e.scale.set(0, 0, 0))
                    }),
                    n.scene = t,
                    n.scenes.push(t),
                    n.camera = r,
    ...
    19 : [function(t, e, n) {
        ...
        TweenUtils.tween = function(t, e) {
            ...
            t).easing(void 0 !== e ? e: TWEEN.Easing.Linear.None).start(),
            n
        },
    ...
    20 : [function(t, e, n) {
        var i = function(t, e) {
            function n(t) {
                u = t,
                t.length > 0 ? c = t[0] : e && e("HMD not available")
            }
            function i() {
            ...
            function r(t) {
                t.pose.orientation ? (S.fromArray(t.pose.orientation), d.makeRotationFromQuaternion(S)) : d.identity(),
                t.pose.position && (P.fromArray(t.pose.position), d.setPosition(P)),
            ...
            this.render = function(e, n, i, o) {
                if (c && y.isPresenting) {
                    ...
                    Array.isArray(e) && (console.warn("THREE.VREffect.render() no longer supports arrays. Use object.layers instead."), e = e[0]);
                    var u, d, _ = t.getSize(),
                    E = c.getLayers();
                    if (E.length) {
                        var b = E[0];
                        u = null !== b.leftBounds && 4 === b.leftBounds.length ? b.leftBounds: x,
                        d = null !== b.rightBounds && 4 === b.rightBounds.length ? b.rightBounds: T
                    } else u = x,
                    d = T;
                    if (l = {
                    ...
                    return i ? (i.viewport.set(l.x, l.y, l.width, l.height), i.scissor.set(l.x, l.y, l.width, l.height)) : (t.setViewport(l.x, l.y, l.width, l.height), t.setScissor(l.x, l.y, l.width, l.height)),
                    t.render(e, R, i, o),
                    i ? (i.viewport.set(h.x, h.y, h.width, h.height), i.scissor.set(h.x, h.y, h.width, h.height)) : (t.setViewport(h.x, h.y, h.width, h.height), t.setScissor(h.x, h.y, h.width, h.height)),
                    t.render(e, M, i, o),
                    i ? (i.viewport.set(0, 0, _.width, _.height), i.scissor.set(0, 0, _.width, _.height), i.scissorTest = !1, t.setRenderTarget(null)) : (t.setViewport(0, 0, _.width, _.height), t.setScissorTest(!1)),
                    a && (e.autoUpdate = !0),
    ...
    21 : [function(t, e, n) {
        var i = {
            ...
            getMessage: function() {
                ...
                }) : t = navigator.getVRDevices ? '您的浏览器支持 WebVR，但不是最新版本。请前往 <a href="http://webvr.info">webvr.info</a> 了解详情。': '您的浏览器不支持 WebVR。前往 <a href="http://webvr.info">webvr.info</a> 寻求帮助。', void 0 !== t) {
    ...
    23 : [function(t, e, n) {
        ...
        TWEEN.Tween = function(t) {
            var _object, n, i, _valuesEnd, o, a, s, c, _isPlaying, l, h, _startTime, p, d, m, v, _onStartCallbackFired, y, _, E;
            ...
            this.start = function(time) {                
                ...
                _isPlaying = !0,
                _onStartCallbackFired = !1,
                _startTime = void 0 !== time ? time: "undefined" != typeof window && void 0 !== window.performance && void 0 !== window.performance.now ? window.performance.now() : Date.now(),
                _startTime += h;
                for (var property in _valuesEnd) {
                    i[property] = _object[property]
                    o[property] = i[property] || 0
                }
                return this
            },
            this.stop = function() {
                return _isPlaying ? (TWEEN.remove(this), _isPlaying = !1, null !== E && E.call(_object), this.stopChainedTweens(), this) : this
            },
            this.stopChainedTweens = function() {
                for (var t = 0,
                e = m.length; e > t; t++) m[t].stop()
            },
            ...
            this.update = function(time) {
                ...
                _onStartCallbackFired === !1 && (null !== v && v.call(_object), _onStartCallbackFired = !0);
                var s = (time - _startTime) / a;
                s = s > 1 ? 1 : s,
                n = s;
                var value = p(s);
                for (property in _valuesEnd) {
                    var start = i[property] || 0,
                    end = _valuesEnd[property];
                    _object[property] = start + (end - start) * value
                }
                if (null !== y && y.call(_object, value), 1 == s) {
                    null !== _ && _.call(_object);
                    for (var d = 0,
                    E = m.length; E > d; d++) m[d].start(time);
                    return ! 1
                }
                return ! 0
            },
    ...
    24 : [function(t, e, n) {
        ...
        s.inherit(r, {
            clone: function(t) {
                var e = t || new s;
                return r.prototype.clone.call(this, e),
                e.name = this.name,
                e.transparent = this.transparent,
                _.each(this.uniforms,
                function(t, n) {
                    var i = t.type;
        ...
        s.create = function(t) {
            ...
            r = t.matcapMap;
            return e.uNormalMapFactor = i(t.normalMapFactor, 1),
    ...
    26 : [function(t, e, n) {
        ...
        s.inherit(r, {
            ...
            clone: function() {
                ...
                return t.uuid = THREE.Math.generateUUID(),
                t
            },
            updateEnvironmentTransform: function() {
                ...
                return function(e) {
                    ...
                    this.uniforms.uEnvironmentTransform.value.makeRotationFromQuaternion(t)
                }
            } (),
        ...
        s.create = function(t) {
            ...
            return e.extensions.shaderTextureLOD ? n = o.getCubemap(t.environment) : r = o.getPanorama(t.environment),
            ...
            t.alphaTest && (e.alphaTest = t.alphaTest, e.defines.ALPHATEST = !0),
            e.extensions.shaderTextureLOD ? (e.defines.CUBEMAP = !0, e.uniforms.uTextureEnvironmentSpecularPBRTextureSize.value.set(256, 256)) : (e.defines.PANORAMA = !0, e.uniforms.uTextureEnvironmentSpecularPBRTextureSize.value.set(1024, 1024)),
    ...
    27 : [function(t, e, n) {
        ...
        r.inherit(THREE.RawShaderMaterial, {
            ...
            clone: function(t) {
                ...
                return THREE.RawShaderMaterial.prototype.clone.call(this, e),
                e.shading = this.shading,
                e.wireframe = this.wireframe,
                e.wireframeLinewidth = this.wireframeLinewidth,
                e.fog = this.fog,
    ...
    // bluebird出品的全功能Promise
    29 : [function(t, e, n) { (function(t, i) {
        // t -> require("34")
        // i -> self || window || {}
         !function(t) {
            if ("object" == typeof n && "undefined" != typeof e) e.exports = t();
                ...
                var r;
                "undefined" != typeof window ? r = window: "undefined" != typeof i ? r = i: "undefined" != typeof self && (r = self),
                r.Promise = t()
            }
        } (function() {
            var e, n, r;
            return function o(t, e, n) {
                ...
                for (var r = "function" == typeof _dereq_ && _dereq_,
                    ...
                    n.exports = function(n, i) {
                        ...
                        function b(t) {
                            for (var e = t[0], n = 1; n < t.length; ++n) {
                                for (var i = t[n], r = e.length - 1, o = e[r], a = -1, s = i.length - 1; s >= 0; --s) if (i[s] === o) {
                                    a = s;
                                    break
                                }
                                for (var s = a; s >= 0; --s) {
                        ...
                        n.config = function(t) {
                            if (t = Object(t), "longStackTraces" in t && (t.longStackTraces ? n.longStackTraces() : !t.longStackTraces && n.hasLongStackTraces() && Y()), "warnings" in t) {
                                ...
                                rt.warnings = !!e,
                                q = rt.warnings,
                                N.isObject(e) && "wForgottenReturn" in e && (q = !!e.wForgottenReturn)
                            }
                        ...
                        c.prototype._promiseCancelled = function() {
                            if (!this._isResolved()) {
                                ...
                                this._promise._popContext();
                                    ...
                                    t = p(this._generator["throw"]).call(this._generator, i),
                                    this._promise._popContext()
                                }
                    ...
                    e.exports = function(e, n, i, r, o, a) {
                        ...
                        s.prototype._promiseFulfilled = function(t, n) {
                            ...
                            if (0 > n) {
                                ...
                                if (c >= 1 && this._inFlight >= c) return i[n] = t,
                                this._queue.push(n),
                                !1;
                                null !== s && (s[n] = t);
                                var u = this._promise,
                                ...
                                m = u._popContext();
                                if (a.checkForgottenReturns(d, m, null !== s ? "Promise.filter": "Promise.map", u), d === f) return this._reject(d.e),
                                !0;
                                var v = r(d, this._promise);
                                if (v instanceof e) {
                                    v = v._target();
                                    var g = v._bitField;
                                    if (0 === (50397184 & g)) return c >= 1 && this._inFlight++,
                                    i[n] = v,
                                    v._proxy(this, -1 * (n + 1)),
                                    !1;
                        ...
                        s.prototype._filter = function(t, e) {
                            for (var n = e.length,
                            i = new Array(n), r = 0, o = 0; n > o; ++o) t[o] && (i[r++] = e[o]);
                            i.length = r,
                            this._resolve(i)
                        },
                    ...
                    e.exports = function(e, n, i, r, o) {
                        ...
                        e.method = function(t) {
                            ...
                            return function() {
                                ...
                                a = i._popContext();
                                return o.checkForgottenReturns(r, a, "Promise.method", i),
                        ...
                        e.attempt = e["try"] = function(t) {
                            ...
                            var h = i._popContext();
                            return o.checkForgottenReturns(c, h, "Promise.try", i),
                ...
                22 : [function(e, n, i) {
                    ...
                    n.exports = function() {
                        ...
                        r.fromNode = r.fromCallback = function(t) {
                            ...
                            i = k(t)(C(e, n));
                            return i === A && e._rejectCallback(i.e, !0),
                        ...
                        r.cast = function(t) {
                            var e = x(t);
                            return e instanceof r || (e = new r(E), e._captureStackTrace(), e._setFulfilled(), e._rejectionHandler0 = t),
                            e
                        },
                        ...
                        r.prototype._then = function(t, e, n, i, o) {
                            ...
                            if (0 !== (50397184 & l)) {
                                ...
                                0 !== (33554432 & l) ? (p = u._rejectionHandler0, f = t) : 0 !== (16777216 & l) ? (p = u._fulfillmentHandler0, f = e, u._unsetRejectionIsUnhandled()) : (d = u._settlePromiseLateCancellationObserver, p = new _("late cancellation observer"), u._attachExtraTrace(p), f = e),
                                v.invoke(d, u, {
                        ...
                        r.prototype._addCallbacks = function(t, e, n, i, r) {
                            ...
                            this._receiver0 = i,
                            "function" == typeof t && (this._fulfillmentHandler0 = null === r ? t: r.bind(t)),
                            "function" == typeof e && (this._rejectionHandler0 = null === r ? e: r.bind(e));
                            else {
                                var a = 4 * o - 4;
                                this[a + 2] = n,
                                this[a + 3] = i,
                                "function" == typeof t && (this[a + 0] = null === r ? t: r.bind(t)),
                                "function" == typeof e && (this[a + 1] = null === r ? e: r.bind(e))
                            }
                        ...
                        r.prototype._settlePromiseFromHandler = function(t, e, n, i) {
                            ...
                            if (0 === (65536 & r)) {
                                ...
                                var a = i._popContext();
                                r = i._bitField,
                                0 === (65536 & r) && (o === w ? i._reject(n) : o === A ? i._rejectCallback(o.e, !1) : (S.checkForgottenReturns(o, a, "", i, this), i._resolveCallback(o)))
                            }
                        },
                        ...
                        r.prototype._reject = function(t) {
                            ...
                            this._isFinal() ? v.fatalError(t, p.isNode) : void((65535 & e) > 0 ? v.settlePromises(this) : this._ensurePossibleRejectionHandled())
                        },
                    ...
                    e.exports = function(e, n, i, r, o) {
                        ...
                        s.prototype._init = function u(t, n) {
                            ...
                            if (o instanceof e) {
                                o = o._target();
                                var s = o._bitField;
                                if (this._values = o, 0 === (50397184 & s)) return this._promise._setAsyncGuaranteed(),
                        ...
                        s.prototype._iterate = function(t) {
                            ...
                            s = 0; n > s; ++s) {
                                ...
                                o ? null !== a && c.suppressUnhandledRejections() : null !== a ? 0 === (50397184 & a) ? (c._proxy(this, s), this._values[s] = c) : o = 0 !== (33554432 & a) ? this._promiseFulfilled(c._value(), s) : 0 !== (16777216 & a) ? this._promiseRejected(c._reason(), s) : this._promiseCancelled(s) : o = this._promiseFulfilled(c, s)
                            }
                        ...
                        s.prototype._cancel = function() { ! this._isResolved() && this._promise.isCancellable() && (this._values = null, this._promise._cancel())
                        },
                    ...
                    e.exports = function(e, n) {
                        ...
                        function a(t, e, n) {
                            for (var i = 0; i < t.length; i += 2) {
                                var r = t[i];
                                if (n.test(r)) for (var o = r.replace(n, ""), a = 0; a < t.length; a += 2) if (t[a] === o) throw new y("Cannot promisify an API that has normal methods with '%s'-suffix\n\n    See http://goo.gl/MqrFmX\n".replace("%s", e))
                            }
                        }
                        function s(t, e, n, i) {
                        ...
                        e.promisify = function(t, e) {
                            ...
                            o = !!e.multiArgs,
                            a = l(t, n, o);
                            return p.copyDescriptors(t, a, i),
                            a
                        },
                ...
                25 : [function(t, e, n) {
                    ...
                    e.exports = function(e, n, i, r) {
                        function o(t) {
                            var e, n = !1;
                            if (void 0 !== s && t instanceof s) e = h(t),
                            n = !0;
                            else {
                                var i = l.keys(t),
                                r = i.length;
                ...
                27 : [function(t, e, n) {
                    ...
                    e.exports = function(e, n, i, r) {
                        function o(t, o) {
                            ...
                            f = 0,
                            p = t.length; p > f; ++f) {
                                var d = t[f]; (void 0 !== d || f in t) && e.cast(d)._then(l, h, void 0, u, null)
                            }
                            return u
                        }
                        var a = t("./util"),
                ...
                28 : [function(t, e, n) {
                    ...
                    e.exports = function(e, n, i, r, o, a) {
                        function s(t, n, i, r) {
                            ...
                            void 0 !== i && (i = e.resolve(i), i._attachCancellationCallback(this)),
                        ...
                        function h(t) {
                            ...
                            var s = i._popContext();
                            return a.checkForgottenReturns(o, s, void 0 !== n._eachValues ? "Promise.each": "Promise.reduce", i),
                            o
                        }
                        var f = e._getDomain,
                        p = t("./util"),
                        ...
                        s.prototype._iterate = function(t) {
                            this._values = t;
                            var n, i, r = t.length;
                            if (void 0 !== this._initialValue ? (n = this._initialValue, i = 0) : (n = e.resolve(t[0]), i = 1), this._currentCancellable = n, !n.isRejected()) for (; r > i; ++i) {
                                var o = {
                                    accum: null,
                                    value: t[i],
                                    index: i,
                ...
                29 : [function(e, n, r) {
                    ...
                    } else o = "undefined" == typeof MutationObserver || "undefined" != typeof window && window.navigator && window.navigator.standalone ? "undefined" != typeof setImmediate ?
                    function(t) {
                        setImmediate(t)
                ...
                33 : [function(t, e, n) {
                    ...
                    e.exports = function(e, n) {
                        ...
                        function s(t, i, r) {
                            ...
                            return h = !1,
                            s && f === u && (s._rejectCallback(f.e, !0, !0), s = null),
                            l
                        }
                        var c = t("./util"),
                        u = c.errorObj,
                ...
                34 : [function(t, e, n) {
                    ...
                    e.exports = function(e, n, i) {
                        ...
                        l = e.delay = function(t, o) {
                            ...
                            +t), i.cancellation() && a._setOnCancel(new r(s))),
                        ...
                        var h = function(t, e, n) {
                            var i;
                            i = "string" != typeof e ? e instanceof Error ? e: new c("operation timed out") : new c(e),
                        ...
                        e.prototype.timeout = function(t, e) {
                            ...
                            t));
                            return i.cancellation() ? (s = this.then(), n = s._then(o, a, void 0, c, void 0), n._setOnCancel(c)) : n = this._then(o, a, void 0, c, void 0),
                            n
                        }
                    }
                },
                        ...
                        e.using = function() {
                            ...
                            var b = e.all(E).then(function(t) {
                                for (var e = 0; e < t.length; ++e) {
                                    var n = t[e];
                                    if (n.isRejected()) return g.e = n.error(),
                                    g;
                                ...
                                o = w._popContext();
                                return a.checkForgottenReturns(i, o, "Promise.using", w),
                                i
                            }),
                            w = b.lastly(function() {
                ...
                36 : [function(e, n, r) {
                    ...
                    C,
                    A = "undefined" != typeof self ? self: "undefined" != typeof window ? window: "undefined" != typeof i ? i: void 0 !== this ? this: null,
                    k = function(t, e) {
                        function n() {
                            this.constructor = t,
                            this.constructor$ = e;
                    ...
                    j = function() {
                        ...
                        return function(n) {
                            if (e(n)) return [];
                            var r = [];
                            t: for (var o in n) if (i.call(n, o)) r.push(o);
                            else {
                                for (var a = 0; a < t.length; ++a) if (i.call(t[a], o)) continue t;
                                r.push(o)
                            }
                            return r
                        }
                    ...
                    if ("undefined" != typeof Symbol && Symbol.iterator) {
                        var I = "function" == typeof Array.from ?
                        function(t) {
                            return Array.from(t)
                        }: function(t) {
    ...
    // lodash
    32 : [function(t, e, n) { (function(t) { (function() {
                function i(t, e) {
                    if (t !== e) {
                        var n = null === t,
                        i = t === R,
                ...
                function r(t, e, n) {
                    for (var i = t.length,
                    r = n ? i: -1; n ? r--:++r < i;) if (e(t[r], r, t)) return r;
                    return - 1
                }
                function o(t, e, n) {
                    if (e !== e) return v(t, n);
                ...
                function c(t, e) {
                    for (var n = -1,
                    i = t.length; ++n < i && e.indexOf(t.charAt(n)) > -1;);
                    return n
                }
                function u(t, e) {
                ...
                function b(t) {
                    for (var e = -1,
                    n = t.length; ++e < n && y(t.charCodeAt(e)););
                    return e
                }
                function w(t) {
                ...
                function T(t) {
                    ...
                    function oe(t, e) {
                        for (var n = -1,
                        i = t.length; ++n < i;) if (!e(t[n], n, t)) return ! 1;
                        return ! 0
                    }
                    function ae(t, e, n, i) {
                        for (var r = -1,
                    ...
                    function fe(t, e) {
                        for (var n = -1,
                        i = t.length; ++n < i;) if (e(t[n], n, t)) return ! 0;
                        return ! 1
                    }
                    function pe(t, e) {
                        for (var n = t.length,
                    ...
                    function ve(t, e, n) {
                        for (var i = -1,
                        r = Us(e), o = r.length; ++i < o;) {
                            var a = r[i],
                            s = t[a],
                            c = n(s, e[a], a, t, e); (c === c ? c === s: s !== s) && (s !== R || a in t) || (t[a] = c)
                        }
                        return t
                    }
                    function ge(t, e) {
                    ...
                    function ye(t, e) {
                        for (var n = -1,
                        i = null == t,
                        r = !i && Zn(t), o = r ? t.length: 0, a = e.length, s = Vo(a); ++n < a;) {
                            var c = e[n];
                    ...
                    function Re(t, e, n, i) {
                        ...
                        return La(t,
                        function(t, a, s) {
                            var c = +e(t, a, s); (n(c, r) || c === i && c === o) && (r = c, o = t)
                        }),
                        o
                    }
                    function Me(t, e, n, i) {
                    ...
                    function Le(t, e, n, i, r, o, a) {
                        ...
                        u = Q,
                        l = Q;
                        s || (u = ia.call(t), u == W ? u = J: u != J && (s = zr(t))),
                        c || (l = ia.call(e), l == W ? l = J: l != J && (c = zr(e)));
                        var h = u == J,
                        f = l == J,
                        p = u == l;
                    ...
                    function Ve(t, e, n, i, r) {
                        ...
                        function(s, c) {
                            ...
                            Be(t, e, c, Ve, n, i, r);
                                ...
                                h = l === R;
                                h && (l = s),
                                l === R && (!o || c in t) || !h && (l === l ? l === u: u !== u) || (t[c] = l)
                            }
                        }),
                        t
                    }
                    function Be(t, e, n, i, r, o, a) {
                        for (var s = o.length,
                        c = e[n]; s--;) if (o[s] == c) return void(t[n] = a[s]);
                        var u = t[n],
                        l = r ? r(u, c, n, t, e) : R,
                        h = l === R;
                        h && (l = c, Zn(c) && (Os(c) || zr(c)) ? l = Os(u) ? u: Zn(u) ? te(u) : [] : Ur(c) || Rr(c) ? l = Rr(u) ? qr(u) : Ur(u) ? u: {}: h = !1),
                        o.push(c),
                        a.push(l),
                        h ? t[n] = i(l, c, r, o, a) : (l === l ? l !== u: u === u) && (t[n] = l)
                    }
                    function ze(t) {
                        return function(e) {
                            return null == e ? R: e[t]
                    ...
                    function tn(t, e) {
                        for (var n = -1,
                        i = e.length,
                        r = Vo(i); ++n < i;) r[n] = t[e[n]];
                        return r
                    }
                    function en(t, e, n, i) {
                        for (var r = t.length,
                        o = i ? r: -1; (i ? o--:++o < r) && e(t[o], o, t););
                    ...
                    function rn(t, e, n) {
                        ...
                        if ("number" == typeof e && e === e && Aa >= r) {
                            for (; r > i;) {
                                var o = i + r >>> 1,
                                a = t[o]; (n ? e >= a: e > a) && null !== a ? i = o + 1 : r = o
                            }
                            return r
                        }
                        return on(t, e, Po, n)
                    ...
                    function on(t, e, n, i) {
                        e = n(e);
                        for (var r = 0,
                        o = t ? t.length: 0, a = e !== e, s = null === e, c = e === R; o > r;) {
                            var u = ya((r + o) / 2),
                            l = n(t[u]),
                            h = l !== R,
                            f = l === l;
                    ...
                    function cn(t, e, n) {
                        for (var i = n.length,
                        r = -1,
                        o = wa(t.length - i, 0), a = -1, s = e.length, c = Vo(s + o); ++a < s;) c[a] = e[a];
                        for (; ++r < i;) c[n[r]] = t[r];
                        for (; o--;) c[a++] = t[r++];
                        return c
                    }
                    function un(t, e, n) {
                        ...
                        r = n.length,
                        o = -1,
                        a = wa(t.length - r, 0), s = -1, c = e.length, u = Vo(a + c); ++o < a;) u[o] = t[o];
                    ...
                    function ln(t, e) {
                        return function(n, i, r) {
                            var o = e ? e() : {};
                            if (i = Vn(i, r, 3), Os(n)) for (var a = -1,
                            s = n.length; ++a < s;) {
                                var c = n[a];
                                t(o, c, i(c, a, n), n)
                            } else La(n,
                    ...
                    function fn(t, e) {
                        return function(n, i) {
                            ...
                            for (var o = e ? r: -1, a = hi(n); (e ? o--:++o < r) && i(a[o], o, a) !== !1;);
                            return n
                        }
                    }
                    function pn(t) {
                    ...
                    function vn(t) {
                        return function(e) {
                            for (var n = -1,
                            i = Ro(lo(e)), r = i.length, o = ""; ++n < r;) o = t(o, i[n], n);
                            return o
                        }
                    }
                    function gn(t) {
                    ...
                    function Tn(t) {
                        return function() {
                            ...
                            i = t ? n: -1, r = 0, o = Vo(n); t ? i--:++i < n;) {
                                var a = o[r++] = arguments[i];
                                if ("function" != typeof a) throw new Xo(z); ! e && y.prototype.thru && "wrapper" == Bn(a) && (e = new y([], !0))
                            }
                            for (i = e ? -1 : n; ++i < n;) {
                                a = o[i];
                                var s = Bn(a),
                            ...
                            return function() {
                                ...
                                for (var r = 0,
                                a = n ? o[r].apply(this, t) : i; ++r < n;) a = o[r].call(this, a);
                                return a
                            }
                        }
                    }
                    ...
                    function Mn(t) {
                        return function(e, n, i) {
                            return "function" == typeof n && i === R || (n = an(n, i, 3)),
                            t(e, n, to)
                        }
                    }
                    function Sn(t) {
                    ...
                    function kn(t, e, n, i, r, o, a, s, c, u) {
                        function l() {
                            ...
                            this && this !== ne && this instanceof l && (I = g || gn(t)),
                            I.apply(D, b)
                        }
                        var h = e & F,
                        f = e & S,
                    ...
                    function qn(t) {
                        var e = t.constructor;
                        return "function" == typeof e && e instanceof e || (e = $o),
                        new e
                    }
                    function Yn(t, e, n) {
                        var i = t.constructor;
                    ...
                    function Kn(t, e) {
                        return t = "number" == typeof t || Ht.test(t) ? +t: -1,
                        e = null == e ? ka: e,
                        t > -1 && t % 1 == 0 && e > t
                    }
                    function Jn(t, e, n) {
                    ...
                    function ri(t, e) {
                        ...
                        return s = e[5],
                        s && (c = t[5], t[5] = c ? un(c, s, e[6]) : te(s), t[6] = c ? _(t[5], G) : te(e[6])),
                        s = e[7],
                        s && (t[7] = te(s)),
                        i & F && (t[8] = null == t[8] ? e[8] : xa(t[8], e[8])),
                        null == t[9] && (t[9] = e[9]),
                        t[0] = e[0],
                        t[1] = r,
                        t
                    ...
                    function ui(t) {
                        for (var e = to(t), n = e.length, i = n && t.length, r = !!i && ni(i) && (Os(t) || Rr(t)), o = -1, a = []; ++o < n;) {
                            var s = e[o]; (r && Kn(s, i) || ea.call(t, s)) && a.push(s)
                        }
                        return a
                    }
                    function li(t) {
                    ...
                    function di(t, e, n) {
                        ...
                        for (var i = 0,
                        r = t ? t.length: 0, o = -1, a = Vo(va(r / e)); r > i;) a[++o] = qe(t, i, i += e);
                        return a
                    }
                    function mi(t) {
                        for (var e = -1,
                        n = t ? t.length: 0, i = -1, r = []; ++e < n;) {
                            var o = t[e];
                            o && (r[++i] = o)
                        }
                        return r
                    ...
                    function Pi() {
                        ...
                        for (var n = 0,
                        i = zn(), r = t.length; ++n < r;) for (var o = 0,
                        a = t[n]; (o = i(e, a, o)) > -1;) pa.call(e, o, 1);
                        return e
                    }
                    function Oi(t, e, n) {
                        var i = [];
                    ...
                    function Ii(t, e, n) {
                        ...
                        if (!i) return [];
                        var r = Di(t);
                        return null == e ? r: (e = an(e, n, 4), ce(r,
                        function(t) {
                            return le(t, e, R, !0)
                        }))
                    }
                    ...
                    function $i() {
                        ...
                        if (t instanceof Z) {
                            var n = t;
                            return this.__actions__.length && (n = new Z(this)),
                            n = n.reverse(),
                            n.__actions__.push({
                                func: zi,
                                args: [e],
                    ...
                    function Xi(t, e, n) {
                        var i = Os(t) ? oe: Te;
                        return n && Jn(t, e, n) && (e = R),
                        "function" == typeof e && n === R || (e = Vn(e, n, 3)),
                        i(t, e)
                    }
                    function Zi(t, e, n) {
                        var i = Os(t) ? se: Se;
                    ...
                    function Ji(t, e, n, i) {
                        var r = t ? Ba(t) : 0;
                        return ni(r) || (t = oo(t), r = t.length),
                        n = "number" != typeof n || i && Jn(e, n, i) ? 0 : 0 > n ? wa(r + n, 0) : n || 0,
                        "string" == typeof t || !Os(t) && Br(t) ? r >= n && t.indexOf(e, n) > -1 : !!r && zn(t, e, n) > -1
                    }
                    function tr(t, e, n) {
                        var i = Os(t) ? ce: Ie;
                        return e = Vn(e, n, 3),
                    ...
                    function pr(t, e, n) {
                        ...
                        function r(e, n) {
                            n && sa(n),
                            u = p = d = R,
                            e && (m = ms(), l = t.apply(f, c), p || u || (c = f = R))
                        }
                        function o() {
                            var t = e - (ms() - h);
                        ...
                        function s() {
                            ...
                            return r && p ? p = sa(p) : p || e === v || (p = fa(o, e)),
                            n && (r = !0, l = t.apply(f, c)),
                            !r || p || u || (c = f = R),
                            l
                        }
                    ...
                    function dr(t, e) {
                        ...
                        var n = function() {
                            ...
                            return n.cache = o.set(r, a),
                            a
                        };
                        return n.cache = new dr.Cache,
                        n
                    }
                    function mr(t) {
                        if ("function" != typeof t) throw new Xo(z);
                    ...
                    function gr(t, e) {
                        ...
                        function() {
                            for (var n = arguments,
                            i = -1,
                            r = wa(n.length - e, 0), o = Vo(r); ++i < r;) o[i] = n[e + i];
                            switch (e) {
                            case 0:
                    ...
                    function _r(t, e, n) {
                        ...
                        r = !0;
                        if ("function" != typeof t) throw new Xo(z);
                        return n === !1 ? i = !1 : Fr(n) && (i = "leading" in n ? !!n.leading: i, r = "trailing" in n ? !!n.trailing: r),
                        pr(t, e, {
                            leading: i,
                            maxWait: +e,
                            trailing: r
                    ...
                    function br(t, e, n, i) {
                        return e && "boolean" != typeof e && Jn(t, e, n) ? e = !1 : "function" == typeof e && (i = n, n = e, e = !1),
                        "function" == typeof n ? be(t, e, an(n, i, 1)) : be(t, e)
                    }
                    function wr(t, e, n) {
                    ...
                    function Hr(t, e, n, i) {
                        return n = "function" == typeof n ? an(n, i, 3) : R,
                        De(t, Gn(e), n)
                    }
                    function Lr(t) {
                        return Nr(t) && t != +t
                    ...
                    function no(t, e, n) {
                        var i = null == t ? R: t[e];
                        return i === R && (null == t || ti(e, t) || (e = fi(e), t = 1 == e.length ? t: Fe(t, qe(e, 0, -1)), i = null == t ? R: t[Mi(e)]), i = i === R ? n: i),
                        jr(i) ? i.call(t) : i
                    }
                    function io(t, e, n) {
                        if (null == t) return t;
                        ...
                        s = t; null != s && ++r < o;) {
                            var c = e[r];
                            Fr(s) && (r == a ? s[c] = n: null == s[c] && (s[c] = Kn(e[r + 1]) ? [] : {})),
                            s = s[c]
                        }
                        return t
                    }
                    function ro(t, e, n, i) {
                        var r = Os(t) || zr(t);
                        if (e = Vn(e, i, 4), null == n) if (r || Fr(t)) {
                            var o = t.constructor;
                    ...
                    function lo(t) {
                        return t = s(t),
                        t && t.replace(Lt, f).replace(Ot, "")
                    }
                    function ho(t, e, n) {
                        t = s(t),
                        e += "";
                        var i = t.length;
                        return n = n === R ? i: xa(0 > n ? 0 : +n || 0, i),
                        n -= e.length,
                        n >= 0 && t.indexOf(e, n) == n
                    }
                    function fo(t) {
                        return t = s(t),
                        t && Et.test(t) ? t.replace(yt, p) : t
                    }
                    function po(t) {
                        return t = s(t),
                        t && Pt.test(t) ? t.replace(St, d) : t || "(?:)"
                    }
                    function mo(t, e, n) {
                        t = s(t),
                        e = +e;
                    ...
                    function vo(t, e, n) {
                        return (n ? Jn(t, e, n) : null == e) ? e = 0 : e && (e = +e),
                        t = Eo(t),
                    ...
                    function _o(t, n, i) {
                        ...
                        var g = n.variable;
                        g || (p = "with (obj) {\n" + p + "\n}\n"),
                        p = (a ? p.replace(dt, "") : p).replace(mt, "$1").replace(vt, "$1;"),
                    ...
                    function bo(t, e, n) {
                        var i = t;
                        return t = s(t),
                        t ? (n ? Jn(i, e, n) : null == e) ? t.slice(b(t)) : t.slice(c(t, e + "")) : t
                    }
                    function wo(t, e, n) {
                        var i = t;
                        return t = s(t),
                        t ? (n ? Jn(i, e, n) : null == e) ? t.slice(0, w(t) + 1) : t.slice(0, u(t, e + "") + 1) : t
                    }
                    function xo(t, e, n) {
                        n && Jn(t, e, n) && (e = R);
                        var i = L,
                    ...
                    function Ao(t, e, n) {
                        if (null == n) {
                            var i = Fr(e),
                            r = i ? Us(e) : R,
                            o = r && r.length ? je(e, r) : R; (o ? o.length: i) || (o = !1, n = e, e = t, t = this)
                        }
                        o || (o = je(e, Us(e)));
                        var a = !0,
                        s = -1,
                    ...
                    function Lo(t, e, n) {
                        ...
                        for (var i = -1,
                        r = wa(va((e - t) / (n || 1)), 0), o = Vo(r); ++i < r;) o[i] = t,
                        t += n;
                        return o
                    }
                    function Do(t, e, n) {
                    ...
                    function Uo(t, e, n) {
                        return n && Jn(t, e, n) && (e = R),
                        e = Vn(e, n, 3),
                        1 == e.length ? pe(Os(t) ? t: li(t), e) : Ke(t, e)
                    }
                    ...
                    ts = gr(function(t) {
                        ...
                        n = e > 2 ? t[e - 2] : R,
                        i = e > 1 ? t[e - 1] : R;
                        return e > 2 && "function" == typeof n ? e -= 2 : (n = e > 1 && "function" == typeof i ? (--e, i) : R, i = R),
                        t.length = e,
                        Ii(t, n, i)
                    }),
                    es = gr(function(t) {
                    ...
                    ds = gr(function(t, e) {
                        if (null == t) return [];
                        var n = e[2];
                        return n && Jn(e[0], e[1], n) && (e.length = 1),
                        Ze(t, Oe(e), [])
                    }),
                    ms = Ta ||
                    function() {
                    ...
                    e.VERSION = M,
                    ee(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"],
                    function(t) {
                        e[t].placeholder = e
                    }),
                    ee(["drop", "take"],
                    ...
                    ee(["join", "pop", "push", "replace", "shift", "sort", "splice", "split", "unshift"],
                    function(t) {
                ...
                Vt = -1,
                Bt = {};
                Bt[ot] = Bt[at] = Bt[st] = Bt[ct] = Bt[ut] = Bt[lt] = Bt[ht] = Bt[ft] = Bt[pt] = !0,
                Bt[W] = Bt[Q] = Bt[rt] = Bt[$] = Bt[q] = Bt[Y] = Bt[X] = Bt[Z] = Bt[K] = Bt[J] = Bt[tt] = Bt[et] = Bt[nt] = Bt[it] = !1;
                var zt = {};
                zt[W] = zt[Q] = zt[rt] = zt[$] = zt[q] = zt[ot] = zt[at] = zt[st] = zt[ct] = zt[ut] = zt[K] = zt[J] = zt[tt] = zt[nt] = zt[lt] = zt[ht] = zt[ft] = zt[pt] = !0,
    ...
    33 : [function(t, e, n) { (function(t) {
            ...
            n.resolve = function() {
                for (var n = "",
                r = !1,
                o = arguments.length - 1; o >= -1 && !r; o--) {
                    var a = o >= 0 ? arguments[o] : t.cwd();
                    if ("string" != typeof a) throw new TypeError("Arguments to path.resolve must be strings");
                    a && (n = a + "/" + n, r = "/" === a.charAt(0))
                }
                return n = e(i(n.split("/"),
                function(t) {
                    return !! t
                }), !r).join("/"),
                (r ? "/": "") + n || "."
            ...
            n.relative = function(t, e) {
                ...
                for (var r = i(t.split("/")), o = i(e.split("/")), a = Math.min(r.length, o.length), s = a, c = 0; a > c; c++) if (r[c] !== o[c]) {
                    s = c;
                    break
                }
    ...
    34 : [function(t, e, n) {
        ...
        process.versions = {},
        process.on = a,
        process.addListener = a,
        process.once = a,
        process.off = a,
        process.removeListener = a,
        process.removeAllListeners = a,
        process.emit = a,
    ...
    36 : [function(t, e, n) {
        ...
        T.inherit(a, {
            init: function() {
                ...
                this.mode === T.VR_MODE ? (this.initInstructions(), this.initInputManager(), this.handleVREvents(), this.initCrosshair(), this.initTransitionScene()) : this.mode === T.DEFAULT_MODE && this.handleNonVREvents(),
            ...
            initInstructions: function() {
                ...
                this.startInstructions && (this.startInstructions.position.z = -.75, this.camera.add(this.startInstructions))
            },
            ...
            initDirLight: function() {
                ...
                _.each([this.interiorScene, this.exteriorScene],
                function(t) {
                    _.each(t.materials,
                    function(t) {
            ...
            initDebugKeyEvents: function() {
                ...
                function(e) {
                    ...
                    }) : 104 == e.keyCode ? _.each([this.interiorScene, this.exteriorScene],
                    function(t) {
                        _.each(t.materials,
                        function(t) {
            ...
            initDrawCallsCounter: function() {
                var t = $("<div id='dc'></div>");
                $("body").append(t),
                t.css("position", "absolute").css("display", "block !important").css("color", "yellow").css("top", "60px").css("left", "20px").css("padding", "3px").css("font-size", "2em").css("background-color", "black").css("z-index", "999999"),
                this.dcCounter = t[0]
            },
            ...
            start: function() {
                ...
                this.mode !== T.DEFAULT_MODE || window.isMobile ? this.mode === T.DEFAULT_MODE && window.isMobile && this.ui.showMoveInstructions() : this.ui.showLookInstructions(),
            ...
            handleNonVREvents: function() {
                var t = null;
                return function() {
                    window.isMobile || $("canvas").on("mousemove",
                    function(t) {
                    ...
                    function(e) {
                        ...
                        var i = null,
                        r = null;
                        this.camera.moving || this.camera.rotating || !this.camera.enabled || (i = this.hud.visible && this.hudPicker.hitTest(), r = this.scenePicker.hitTest()),
                        window.isMobile && !i && r && "floor" === r.name && (this.ui.updateMarker(this.scenePicker.getPoint()), this.ui.showMarker(), t && clearTimeout(t), t = setTimeout(function() {
                            this.ui.hideMarker(),
                            t = null
                        }.bind(this), 2e3)),
                        i ? this.hudPicker.onTap() : r && this.scenePicker.onTap()
                    }.bind(this))
                }
            } (),
            handleHudEvents: function() {
                this.hud.on("selectMaterial",
                function(t) {
                    this.materialManager.setObjectMaterial(this.currentSelected, t),
                    this.hud.setCurrent(t),
                    this.materialInstructionsVisible && (this.ui.hideMaterialInstructions(), this.materialInstructionsVisible = !1)
                },
                this)
            },
            ...
            initCamera: function() {
                ...
                this.scene.add(t),
                t.enabled = !0,
                this.mode === T.VR_MODE && this.camera.vrControls.setVRDisplay(this.vrDisplay)
            },
            initTransitionScene: function() {
                ...
                e.add(t),
                this.transitionQuad = t,
                this.transitionScene = e
            },
            fadeOut: function(t) {
            ...
            initObjectPickers: function() {
                ...
                this)
                _.each(this.scene.getObjectByName("colliders").children,
                function(t) {
                    t.visible = !0,
            ...
            handlePickerEvents: function() {
                ...
                function(t, e) {
                    ...
                    }.bind(this)), this.ui.hideMoveInstructions()) : this.VREnabled || this.camera.moveTo(e.x, e.z, 1e3), this.$container.removeClass("hovering"), this.ui.activateMarker(), this.currentSelected && this.deselectObject(this.currentSelected)) : r(t) ? n = t: r(t.parent) && (n = t.parent),
                    n && n !== this.currentSelected && this.selectObject(n)
                },
                this),
                this.scenePicker.on("enter",
                function(t) {
            ...
            selectObject: function(object) {
                ...
                window.isMobile && this.isSelecting || (this.isSelecting = !0, setTimeout(function() {
                    this.isSelecting = !1
                }.bind(this), 1500), this.clearHighlight(object), this.currentSelected = object, this.hud.show(), this.hud.setPanel(name), window.isMobile ? this.selectObjectMobile(name) : this.VREnabled ? this.selectObjectVR(name) : (this.camera.setOrbitDistances(0, 1 / 0), this.camera.setState(name).onComplete(function() {
            ...
            initSeaHighlights: function() {
                ...
                t.material = new E,
                t.material.map = n,
                t.material.uniforms.offsetRepeat.value.set(n.offset.x, n.offset.y, n.repeat.x, n.repeat.y),
                ...
                return function() {
                    if (this.VREnabled) {
                        ...
                        if (this.camera.updateMatrixWorld(!0), this.crosshair.getWorldPosition(e), e.project(this.camera), n.set(e.x, e.y), r) {
                            ...
                            this),
                            o > .5 ? (this.crosshair.fadeOut(), this.ui.fadeInMarker()) : (this.crosshair.fadeIn(), this.ui.fadeOutMarker())
                        }
                    }
                }
            } (),
            ...
            updateFlares: function() {
                ...
                return function() {
                    ...
                    this.flares.forEach(function(i, o) {
                        e.subVectors(i.position, n).normalize(),
                        t.set(n, e);
            ...
            update: function(t) {
                this.VREnabled || this.mode !== T.VR_MODE || (this.effect.requestPresent(), this.VREnabled = !0),
            ...
            render: function() {
                ...
                if (this.mode === T.VR_MODE) {
                    ...
                    if (this.mode === T.DEFAULT_MODE) {
                        this.renderScene(this.interiorScene, this.camera)
                        logCall()
                        this.renderScene(this.exteriorScene, this.camera)
                        logCall()
                        this.hoverScene.children.length > 0 && (this.renderScene(this.hoverScene, this.camera), logCall())
                        this.hud.render(this.renderer)
                        logCall()
                        this.renderScene(this.cameraScene, this.camera)
                        logCall()
                        this.config.logCalls && (this.dcCounter.textContent = t + " DC")
                    }
                }
            },
            requestAnimationFrame: function(t) {
    ...
    38 : [function(t, e, n) {
        ...
        l = function(t) {
            ...
            this.moving = !1,
            this.rotating = !1,
            t.vr ? (this.vr = !0, this.vrControls = new o(this), this.mode = l.VR_MODE, this.moveTo(0, 0)) : (window.isMobile ? (this.lookControls = new s(this, document.getElementById("main_canvas")), this.lookControls.setRotationAngle(3.6)) : (this.lookControls = new a(this, t.$container), u.ENABLE_DAMPING && (this.lookControls.enableDamping = !0, this.lookControls.dampingFactor = .25)), this.orbitControls = new c(this, {
                autoSpeed: u.ENABLE_DAMPING ? .1 : 1,
                autoDelay: 3e3,
                domElement: document.getElementById("main_canvas")
            }), this.orbitControls.enableZoom = !!u.ENABLE_ZOOM, this.orbitControls.enablePan = !!u.ENABLE_PAN, this.orbitControls.enabled = !1, this.orbitControls.maxPolarAngle = Math.PI / 2, u.ENABLE_DAMPING && (this.orbitControls.enableDamping = !0, this.orbitControls.dampingFactor = .065, this.orbitControls.rotateSpeed = .05), this._target = new THREE.Object3D, this._target.position.z = -1, this.add(this._target), this.mode = l.LOOK_MODE),
            t.states && (this.initStates(t.states), this.states.start ? (this.position.copy(this.states.start[0].position), this.quaternion.copy(this.states.start[0].quaternion), this.vr || this.lookControls.setOrientationFromCamera()) : this.moveTo( - 3.5, 3))
        };
        l.inherit(i, {
            initStates: function(t) {
                ...
                t.forEach(function(t) {
                    ...
                    this.states[e] ? this.states[e].push(t) : this.states[e] = [t],
                    t.children.length > 0 && (t.target = new THREE.Vector3, t.children[0].getWorldPosition(t.target))
                },
                this)
            },
            setState: function(t) {
                if (!this.vr) {
                    ...
                    var e = _.min(this.states[t],
                    function(t) {
                        return this.position.distanceTo(t.position)
                    }.bind(this)),
                    n = 1e3;
                    return this.isTransitioning = !0,
                    this.tweenOrbitTargetTo(e.target, n).onComplete(function() {
            ...
            moveTo: function() {
                ...
                return function(e, n, i) {
                    ...
                    i > 0 && !this.vr ? (this.trigger("startMove"), this.moving = !0, this.tweenPositionTo(t, i).onComplete(function() {
                        this.trigger("endMove"),
                        this.moving = !1
                    }.bind(this))) : (this.position.copy(t), this.vr && (this.updateMatrixWorld(!0), this.vrControls.setPosition(this))),
                    this.firstMove || (this.trigger("firstMove"), this.firstMove = !0),
    ...
    43 : [function(t, e, n) {
        ...
        i.prototype = {
            update: function() {
                ...
                return function() {
                    return t.set(this.phi, this.theta, 0),
                    e.setFromEuler(t),
                    this.enableDamping ? this.camera.quaternion.slerp(e, this.dampingFactor) : this.camera.quaternion.copy(e),
                    this
                }
            } (),
            setOrientationFromCamera: function() {
                var t = new THREE.Euler(0, 0, 0, "YXZ");
                return function() {
                    return t.setFromQuaternion(this.camera.quaternion),
                    this.phi = t.x,
                    this.theta = t.y,
                    this
                }
        ...
        r.prototype = {
            ...
            hitTest: function() {
                ...
                return function(i) {
                    var r;
                    this.camera.getWorldPosition(n),
                    this.vr || i ? (this.camera.getWorldDirection(e), t.set(n, e)) : t.setFromCamera(this.mouseCoords, this.camera);
                    ...
                    return (r && this.currentObj && this.currentObj !== r || !r && this.currentObj) && (this.trigger("leave", this.currentObj), this.currentObj = null),
                    r && !this.currentObj && (this.trigger("enter", r, this.point), this.currentObj = r),
                    r
                }
            } (),
    ...
    46 : [function(t, e, n) {
        function i(t) {
            ...
            o.isIOS() ? this.filterQ = new THREE.Quaternion( - 1, 0, 0, 1) : this.filterQ = new THREE.Quaternion(1, 0, 0, 1),
        ...
        i.prototype.run_ = function() {
            ...
            i.inverse(),
            a && console.log("Delta: %d deg, G_est: (%s, %s, %s), G_meas: (%s, %s, %s)", THREE.Math.radToDeg(o.getQuaternionAngle(i)), this.estimatedGravity.x.toFixed(1), this.estimatedGravity.y.toFixed(1), this.estimatedGravity.z.toFixed(1), this.measuredGravity.x.toFixed(1), this.measuredGravity.y.toFixed(1), this.measuredGravity.z.toFixed(1));
        ...
        i.prototype.accelToQuaternion_ = function(t) {
            ...
            e.normalize();
            var n = new THREE.Quaternion;
            return n.setFromUnitVectors(new THREE.Vector3(0, 0, -1), e),
            n.inverse(),
            n
        },
    ...
    48 : [function(t, e, n) {
        function i(t) {
            ...
            c.isIOS() ? this.filterToWorldQ.setFromAxisAngle(new THREE.Vector3(1, 0, 0), Math.PI / 2) : this.filterToWorldQ.setFromAxisAngle(new THREE.Vector3(1, 0, 0), -Math.PI / 2),
        ...
        i.prototype.getOrientation = function() {
            ...
            r.TOUCH_PANNER_DISABLED || t.multiply(this.touchPanner.getOrientation()),
    ...
    49 : [function(t, e, n) {
        ...
        i.prototype.getPrediction = function(t, e, n) {
            if (!this.previousTimestampS) return this.previousQ.copy(t),
            ...
            i.normalize();
            var o = e.length();
            if (o < THREE.Math.degToRad(20)) return r && console.log("Moving slowly, at %s deg/s: no prediction", THREE.Math.radToDeg(o).toFixed(1)),
            this.outQ.copy(t),
            this.previousQ.copy(t),
            this.outQ;
            var a = (n - this.previousTimestampS, o * this.predictionTimeS);
            return this.deltaQ.setFromAxisAngle(i, a),
    ...
    54 : [function(t, e, n) {
        ...
        o = function(t, e, n) {
            ...
            this.sunDirection = r(n.sunDirection, new THREE.Vector3(.70707, .70707, 0)),
    ...
    58 : [function(t, e, n) {
        ...
        function s(t) {
            return p.texturePath = x + t + "/",
            d.loadScene(t, x + "scenes/", l, y)
        }
        function c() {
            C.show(),
            o();
            ...
            THREE.Extensions.get("EXT_shader_texture_lod") ? e.cubemaps = [t + "/cubemap.bin"] : e.panoramas = [t + "/panorama.bin"],
        ...
        p.manager.onProgress = function(t, e, n) {
            F.html(Math.round(e / h.ASSET_COUNT * 100)),
            o()
        },
        THREE.MaterialLoader.setShaders(g),
        window.VRenabled = v.isAvailable();
        var B = v.isLatestAvailable();
        VRenabled ? B || H.html("<img src='img/missing-headset.png'>Your version of WebVR is out of date. <a href='http://webvr.info'>Fix this</a>") : H.html("<img src='img/missing-headset.png'>You browser does not support WebVR. <br/>Falling back to non-VR mode."),
        VRenabled && navigator.getVRDisplays ? navigator.getVRDisplays().then(function(t) {
            t.length > 0 ? (a(t[0]), V = !0) : (console.error("No VR display"), H.html("<img src='img/missing-headset.png'>您的浏览器支持 WebVR，但我们未能找到您的头戴式设备。已回退到无VR模式。"), a())
    ...
    59 : [function(t, e, n) {
        ...
        r.prototype = {
            initSpecialProperties: function() {
                ...
                function(t) {
                    _.each(t.materials,
                    function(t) { ! t.pbr || a.indexOf(t.name) > -1 || (t.defines.OCCLUDE_SPECULAR = !0)
                    })
                });
                var s = this.getMaterial("pool_interior");
                s && (s.exposure = 1.25),
                _.each(this.scenes[1].materials,
                function(t) {
            ...
            initMaterials: function() {
                ...
                this.configurables.forEach(function(t) {
                    ...
                    r.forEach(function(t) {
                        ...
                        a && (t.lightMap = a, t.lightMapM = s, t.defines.USE_LIGHTMAP = !0),
                        c && (t.uniforms.sTextureAOMap2.value = c, t.defines.USE_AOMAP2 = !0),
                        u && (t.uniforms.sTextureNormalMap2.value = u, t.defines.USE_NORMALMAP2 = !0),
                        t.needsUpdate = !0,
            ...
            crossFadeMaterial: function() {
                ...
                return function(n, i) {
                    if (this.crossFade) return void this.crossFade.onComplete(function() {
                        ...
                        e.opacity = 0,
                        this.crossFade = null,
                        i !== this.currentFadingMaterial && this.crossFadeMaterial(n, i)
                    }.bind(this));
            ...
            getMaterial: function(t) {
                for (var e, n = 0; n < this.scenes.length && !(e = _.find(this.scenes[n].materials,
                function(e) {
                    return e.name === t
                })); n++);
                return e
    ...
    // replacement_material_selector
    64 : [function(t, e, n) {
        var i = t("16"),
        r = function(t) {
            return THREE.Object3D.call(this),
        ...
        r.inherit(THREE.Object3D, {
            ...
            createSphere: function(t, e, n, r) {
                ...
                return o.material.uDiffuseSPH = new Float32Array(c, 27),
            ...
            show: function() {
                ...
                return function(e) {
                    ...
                    this.children.forEach(function(t) {
                        ...
                        t.stroke.material.opacity = 1
                    }),
                    e ? (this.visible = true, this.children.forEach(function(child, index) {
                        var i = {
                            scale: scale
                        };
    ...
    65 : [function(t, e, n) {
        ...
        a = function(parameters) {
            ...
            return data.materials.forEach(function(t) {
                var e = createTexture("material", t);
                this.materialTextures.push(e)
            },
            this),
            r(name, this.nameObj),
            r(dimensions, this.dimensionsObj),
        ...
        a.inherit(THREE.Object3D, {
            initLayout: function(t, e) {
                ...
                this.innerContainer.position.set(e.width * -.5 + i, .5 * e.height - i, 0),
                ...
                a.children[0].material.polygonOffsetFactor = -.1
            },
            ...
            resize: function(t) {
                ...
                this.innerContainer.position.set(t.width * -.5 + n, .5 * t.height - n, 0),
            ...
            show: function(t) {
                ...
                t && (this.nameObj.visible = !1, this.materialObj.visible = !1, this.dimensionsObj.visible = !1, this.animateLine(), setTimeout(this.animateUpperElement.bind(this), 300), setTimeout(this.animateLowerElement.bind(this), 500)),
            ...
            fadeInGradient: function() {
                ...
                var x = this.gradient.animation.tween.reset(this.gradient.animation).to({
            ...
            addElement: function(t, e, n) {
                ...
                return function(t, e, n) {
                    ...
                    return t.position.set(o, r, 0),
                    t.material && (t.material = t.material.clone(), t.material.depthTest = !1),
                    t.traverse(function(t) {
                        t.renderOrder = 1
                    }),
                    t
    ...
    66 : [function(t, e, n) {
        ...
        s.prototype = {
            initVRInstructions: function() {
                ...
                this.VRMoveInstructions && (this.VRMoveInstructions.position.z = -.75, this.VRMoveInstructions.position.y = -.25, this.camera.add(this.VRMoveInstructions)),
                this.VRConfigureInstructions = this.scene.getObjectByName("configure_instructions"),
                this.VRConfigureInstructions && (this.VRConfigureInstructions.position.z = -.75, this.VRConfigureInstructions.position.y = -.25, this.camera.add(this.VRConfigureInstructions))
            },
            ...
            highlightObject: function(t) {
                ...
                this.onEnterObject(),
                this.vr && (this.VRConfigureInstructions && (this.VRConfigureInstructions.visible = !0), this.VRMoveInstructions && (this.VRMoveInstructions.visible = !1))
            },
            clearHighlight: function() {
                this.currentHighlighted && (this.currentHighlighted.stroke.visible = !1, this.currentHighlighted = null),
                this.onLeaveObject(),
                this.vr && this.VRConfigureInstructions && (this.VRConfigureInstructions.visible = !1)
            },
            ...
            updateMarker: function(t) {
                t && (this.marker.position.x = t.x, this.marker.position.z = t.z),
                this.marker.visible && !this.$container.hasClass("hovering") && this.$container.addClass("hovering")
            },
            showMarker: function() {
                this.marker.visible = !0,
                this.$container.addClass("hovering"),
                this.vr && this.VRMoveInstructions && (this.VRMoveInstructions.visible = !0)
            },
            hideMarker: function() {
            ...
            activateMarker: function() {
                r.tween(500, TWEEN.Easing.Quadratic.Out).onUpdate(function(t) {
                    this.marker.material.opacity = .5 + .5 * (1 - t),
            ...
            hideMoveInstructions: function() {
                ...
                this.vr && this.VRMoveInstructions && (this.camera.remove(this.VRMoveInstructions), this.VRMoveInstructions = null)
            },
            update: function(t) {
    ...
    67 : [function(t, e, n) {
        function i(t) {
            ...
            t.light && t.light instanceof THREE.Light ? n.copy(t.light.position) : n.set( - .2, .3, -.5),
            ...
            t.object ? (THREE.Mesh.call(this, t.object.geometry, this.effect.material), this.position.copy(t.object.position), this.rotation.copy(t.object.rotation), this.scale.copy(t.object.scale)) : (THREE.Mesh.call(this, new THREE.PlaneBufferGeometry(2e3, 2e3, 10, 10), this.effect.material), this.rotation.x = .5 * -Math.PI, this.position.y -= 20),
        ...
        i.inherit(THREE.Mesh, {
            update: function(t) {
                this.effect.material.uniforms.time && (this.effect.material.uniforms.time.value += .25 * t.delta),
                this.effect.update()
            },
            render: function() {
