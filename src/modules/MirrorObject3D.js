...
class MirrorObject3D extends THREE.Object3D {
  ...
  initMaterial() {
    var uniforms = THREE.UniformsUtils.clone(MirrorConfig.uniforms)
    this.material = new THREE.ShaderMaterial({
      fragmentShader: MirrorConfig.fragmentShader,
      vertexShader: MirrorConfig.vertexShader,
      uniforms: uniforms
    })
  }
