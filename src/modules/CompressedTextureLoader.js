...
var CompressedTextureLoader = function(size, interleaved, loadingManager) {
  this.manager = void 0 !== loadingManager ? loadingManager : THREE.DefaultLoadingManager
  this._size = size
  this._interleaved = interleaved
}

CompressedTextureLoader.prototype = Object.create(THREE.CompressedTextureLoader.prototype)
CompressedTextureLoader.prototype._parser = function(buffer) {
...
export default CompressedTextureLoader
