...
class RawShaderMaterial extends BaseRawShaderMaterial {
  constructor(params) {
  ...
  _clone(object) {
    debugger
    // TODO：何时调用？
    var material = object || new RawShaderMaterial()
  ...
  clone() {
    var material = RawShaderMaterial.create(this.createOptions)
